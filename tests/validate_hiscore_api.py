...
class TestHiscore(unittest.TestCase):
    def test_api_length(self):
        """Check to see if the API returns the same number of skills, minigames, and bosses that are mentioned in const.py. If this test fails, the itmes in const.py need to be updated."""
